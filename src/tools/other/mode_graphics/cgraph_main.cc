...
void CgraphBase::italic(double size)
...
void CgraphBase::bold(double size)
...
void CgraphBase::bolditalic(double size)
...
void CgraphBase::dingbats(double size)
...
void CgraphBase::symbol(double size)
