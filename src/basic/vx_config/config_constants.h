...
static const char conf_key_grib_desc_map[]     = "grib_desc_map";
static const char conf_key_grib_name_map[]     = "grib_name_map";
static const char conf_key_grib_unit_map[]     = "grib_unit_map";
