...
////////////////////////////////////////////////////////////////////////
//
// Code for class MetNcMetRADataFile
//
////////////////////////////////////////////////////////////////////////

MetNcMetRADataFile::MetNcMetRADataFile() {
...
MetNcMetRADataFile::MetNcMetRADataFile(const MetNcMetRADataFile &) {
...
MetNcMetRADataFile & MetNcMetRADataFile::operator=(const MetNcMetRADataFile &) {
...
void MetNcMetRADataFile::nc_met_init_from_scratch() {
...
bool MetNcMetRADataFile::open(const char * _filename) {
   ...
   if(!MetNc->open(_filename)) {
      mlog << Error << "\nMetNcMetRADataFile::open(const char *) -> "
...
void MetNcMetRADataFile::dump(ostream & out, int depth) const {
...
bool MetNcMetRADataFile::data_plane(VarInfo &vinfo, DataPlane &plane) {
   bool status = false;
...
int MetNcMetRADataFile::data_plane_array(VarInfo &vinfo,
...
int MetNcMetRADataFile::index(VarInfo &vinfo) {
