...
///////////////////////////////////////////////////////////////////////////////
//
//  Code for class VarInfoNcMetRA
//
///////////////////////////////////////////////////////////////////////////////

VarInfoNcMetRA::VarInfoNcMetRA() {
...
VarInfoNcMetRA::VarInfoNcMetRA(const VarInfoNcMetRA &f) {
...
VarInfoNcMetRA & VarInfoNcMetRA::operator=(const VarInfoNcMetRA &f) {
...
VarInfo *VarInfoNcMetRA::clone() const {

   VarInfoNcMetRA *ret = new VarInfoNcMetRA(*this);
...
void VarInfoNcMetRA::init_from_scratch() {
...
void VarInfoNcMetRA::assign(const VarInfoNcMetRA &v) {
   int i;
...
void VarInfoNcMetRA::dump(ostream &out) const {

   VarInfo::dump(out);

   // Dump out the contents
   out << "VarInfoNcMetRA::dump():\n"
       << "  Dimension:\n";
   Dimension.dump(out);
...
void VarInfoNcMetRA::add_dimension(int dim) {
   Dimension.add(dim);
   return;
}
...
void VarInfoNcMetRA::set_magic(const ConcatString &nstr, const ConcatString &lstr) {
...
void VarInfoNcMetRA::set_dict(Dictionary &dict){
...
bool VarInfoNcMetRA::is_precipitation() const {
...
bool VarInfoNcMetRA::is_specific_humidity() const {
...
bool VarInfoNcMetRA::is_u_wind() const {
...
bool VarInfoNcMetRA::is_v_wind() const {
...
bool VarInfoNcMetRA::is_wind_speed() const {
...
bool VarInfoNcMetRA::is_wind_direction() const {
