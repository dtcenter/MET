...
static const LambertData ncep_lambert_grids [] = {
   ...
   { "G236", 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 40.635,    ncep_earth_radius_km,  151,  113 },
   { "G237", 50.0, 50.0, 16.201,   74.28,  0.0, 0.0, 107.0, 32.463,    ncep_earth_radius_km,   54,   47 },
