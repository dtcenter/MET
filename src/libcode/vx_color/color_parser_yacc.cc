...
#line 171 "color_parser_yacc.yy"
    { add_to_table((yyvsp[(1) - (2)].nval), (yyvsp[(2) - (2)].cval)); }
    break;

  case 7:
#line 172 "color_parser_yacc.yy"
    { add_2_to_table((yyvsp[(1) - (3)].nval), (yyvsp[(2) - (3)].nval), (yyvsp[(3) - (3)].cval)); }
    break;

  case 8:
#line 176 "color_parser_yacc.yy"
    { assign_color_1((yyvsp[(1) - (3)].text), (yyvsp[(3) - (3)].cval)); }
    break;

  case 9:
#line 177 "color_parser_yacc.yy"
    { assign_color_2((yyvsp[(1) - (3)].ival), (yyvsp[(3) - (3)].cval)); }
    break;

  case 10:
#line 181 "color_parser_yacc.yy"
    { (yyval.cval) = do_simple_color((yyvsp[(2) - (7)].nval), (yyvsp[(4) - (7)].nval), (yyvsp[(6) - (7)].nval)); }
    break;

  case 11:
#line 182 "color_parser_yacc.yy"
    { (yyval.cval) = blend((yyvsp[(3) - (8)].cval), (yyvsp[(5) - (8)].cval), (yyvsp[(7) - (8)].nval)); }
    break;

  case 12:
#line 183 "color_parser_yacc.yy"
    { (yyval.cval) = hsv((yyvsp[(3) - (8)].nval), (yyvsp[(5) - (8)].nval), (yyvsp[(7) - (8)].nval)); }
    break;

  case 13:
#line 184 "color_parser_yacc.yy"
    { (yyval.cval) = cmyk((yyvsp[(3) - (10)].nval), (yyvsp[(5) - (10)].nval), (yyvsp[(7) - (10)].nval), (yyvsp[(9) - (10)].nval)); }
    break;

  case 14:
#line 185 "color_parser_yacc.yy"
    { (yyval.cval) = do_gray((yyvsp[(3) - (4)].nval)); }
    break;

  case 15:
#line 186 "color_parser_yacc.yy"
    { (yyval.cval) = color_lookup((yyvsp[(1) - (1)].ival)); }
    break;

  case 16:
#line 190 "color_parser_yacc.yy"
    { (yyval.nval) = int_to_num((yyvsp[(1) - (1)].ival)); }
    break;

  case 17:
#line 191 "color_parser_yacc.yy"
    { (yyval.nval) = int_to_double((yyvsp[(1) - (1)].dval)); }
    break;


/* Line 1267 of yacc.c.  */
#line 1555 "color_parser_yacc.cc"
      default: break;
    }
