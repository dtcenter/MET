...
class TcHdrColumns {
   ...
   public:
     ...
     ~TcHdrColumns();
      ...
      ConcatString init_mask   () const;      ConcatString valid_mask  () const;
...
inline int          TcHdrColumns::init_hh     () const { return(InitTime % sec_per_hour); }
