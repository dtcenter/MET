...
//
// MET #2532:
//   If the full circle value is not defined, compute
//   it as the mean of the non-zero quadrants.
//
////////////////////////////////////////////////////////////////////////
...
void QuadInfo::set_al_from_quad_vals() {
   ...
   if(is_bad_data(ALVal) &&
      (!is_bad_data(NEVal) || !is_bad_data(SEVal) ||
