...
extern void compute_gc_dist_stdev(const double lat, const double lon, const NumArray &lats, const NumArray &lons, double &spread, double &mean);
//extern double compute_gc_dist_stdev(const double lat, const double lon, const NumArray &lats, const NumArray &lons);
