...
void write_seeps_cols(const SeepsAggScore *seeps,
   ...
   at.set_entry(r, c+1, bad_data_double); // seeps->s12);  // s12
   at.set_entry(r, c+2, bad_data_double); // seeps->s13);  // S13
   at.set_entry(r, c+3, bad_data_double); // seeps->s21);  // s21
   at.set_entry(r, c+4, bad_data_double); // seeps->s23);  // s23
   at.set_entry(r, c+5, bad_data_double); // seeps->s31);  // s31
   at.set_entry(r, c+6, bad_data_double); // seeps->s32);  // s32
