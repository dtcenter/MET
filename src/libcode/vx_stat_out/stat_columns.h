...
extern void open_txt_file (std::unique_ptr<std::ofstream> &, const char *);
extern void close_txt_file(std::unique_ptr<std::ofstream> &, const char *);
...
extern void write_mpr_cols   (const PairDataPoint *, int,
                              AsciiTable &, int, int);
extern void write_seeps_cols (const SeepsAggScore *,
                              AsciiTable &, int, int);
