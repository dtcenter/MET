...
-------------------------------------------------
  ...
  .. dropdown:: Bugfixes
     ...
     * Bugfix METbaseimage: ncdump fails with runtime linker error (`METbaseimage#24 <https://github.com/dtcenter/METbaseimage/issues/24>`_).
     ...
     * **Bugfix: Can't find MET_SEEPS_GRID_CLIMO_NAME in grid_stat config file** (`#2601 <https://github.com/dtcenter/MET/issues/2601>`_).
  ...
  .. dropdown:: Enhancements
     ...
     * **Support more tripolar data to point2grid** (`#2857 <https://github.com/dtcenter/MET/issues/2857>`_).
