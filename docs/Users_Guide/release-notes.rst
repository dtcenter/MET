...
MET Version 12.0.4 Release Notes (20250929)
-------------------------------------------

  .. dropdown:: Bugfixes

     * Fix STAT-Analysis handling of zero-length vectors when aggregating MPR inputs and writing WDIR or VCNT outputs
