...
MET Version 12.0.0-beta5 Release Notes (20240626)
-------------------------------------------------

  .. dropdown:: Repository, build, and test

     * Reimplement and enhance the Perl-based (unit.pl) unit test control script in Python (`#3717 <https://github.com/dtcenter/MET/issues/2717>`_).
     * Update compilation script and configuration files (`#2753 <https://github.com/dtcenter/MET/issues/2753>`_).
     * Fix release checksum action (`#2929 <https://github.com/dtcenter/MET/issues/2929>`_).
  ...
  .. dropdown:: Bugfixes
     ...
     * Bugfix: ncdump fails with runtime linker error (`#24 <https://github.com/dtcenter/MET/issues/24>`_).
     * Bugfix: Stat-Analysis errors out for jobs with -dump_row and -line_type for VCNT, RPS, DMAP, and SSIDX line types (`#2888 <https://github.com/dtcenter/MET/issues/2888>`_).
     ...
     * **Bugfix: Can't find MET_SEEPS_GRID_CLIMO_NAME in grid_stat config file #2601 (`#2601 <https://github.com/dtcenter/MET/issues/2601>`_).**
  ...
  .. dropdown:: Enhancements
     ...
     * Change -config option to -ugrid_config at grid_stat and point_stat (`#2842 <https://github.com/dtcenter/MET/issues/2842>`_).
     ...
     * **Support more tripolar data to point2grid #2857 (`#2857 <https://github.com/dtcenter/MET/issues/2857>`_).**
