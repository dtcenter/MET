...
.. note:: Masking regions can be defined in a variety of ways, described
          below. However, if no geographic masking regions are specified,
          the MET tools automatically set "grid" equal to "FULL" to verify
          all data in the entire input domain.
