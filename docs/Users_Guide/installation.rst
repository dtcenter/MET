...
subdirectory (e.g. */d1/met/12.1.0*).
Next, download the
`compile_MET_all.sh <https://raw.githubusercontent.com/dtcenter/MET/main_v12.1/internal/scripts/installation/compile_MET_all.sh>`_
script and
...
tar file (e.g. **v12.1.0.tar.gz**) and place it in
...
`scripts/installation/config <https://github.com/dtcenter/MET/tree/main_v12.1/internal/scripts/installation/config>`_
directory.
...
.. dropdown:: REQUIRED
    ...
    **TEST_BASE** – Format is */d1/met/12.1.0*. This is the MET
    ...
    **MET_SUBDIR** – Format is */d1/met/12.1.0*. This is the location where the top-level MET
    subdirectory will
    be installed and is often set equivalent to **TEST_BASE** (e.g. ${TEST_BASE}).

    **MET_TARBALL** – Format is *v12.1.0.tar.gz*. This is the name of the downloaded MET tarball.
...
.. code-block:: ini
  ...
  /contrib/met/12.1.0$ ls
  compile_MET_all.sh  install_met_env.hera  tar_files

  /contrib/met/12.1.0$ ls tar_files
...
.. code-block:: ini
  ...
  /contrib/met/12.1.0$ ls
  MET-12.1.0  bin  compile_MET_all.sh  external_libs  install_met_env.hera  share  tar_files
...
.. code-block:: ini
  ...
  docker run -it --rm dtcenter/met:12.1.0 /bin/bash
...
.. code-block:: ini
  ...
  singularity build met-12.1.0.sif docker://dtcenter/met:12.1.0
...
.. code-block:: ini
  ...
  singularity exec met-12.1.0.sif plot_data_plane /home/data/fcst_006.grb2 image_output.ps ‘name=”TMP”; level=”Z0”;’
...
.. code-block:: ini
  ...
  singularity instance stop /path/to/container/met-12.1.0.sif met-12.1.0
