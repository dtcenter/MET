...
For more detail on generating GSI diagnostic files and their contents, see the `GSI User's Guide (pdf) <https://dtcenter.org/sites/default/files/community-code/gsi/docs/users-guide/GSIUserGuide_v3.7.pdf>`_.
