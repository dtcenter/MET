...
//   008    01/24/20  Halley Gotway   Add aggregate ERPS lines.
//
////////////////////////////////////////////////////////////////////////
...
extern void write_job_aggr_erps(STATAnalysisJob &, STATLineType,
               map<ConcatString, AggrERPSInfo> &, AsciiTable &);
