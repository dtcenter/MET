...
static const StereographicData ncep_st_grids [] = {
   ...
   // { "G224", 'S',  60.0,  20.826, -120.0,   0.0, 0.0,  105.0, 381.0,    6367.47,   65,  65 }, 
      { "G224", 'S', -60.0, -90.0,      0.0,  32.0, 32.0,  -75.0, 381.0,    6367.47,   65,  65 },
...
static const LambertData ncep_lambert_grids [] = {
   ...
   { "G130", 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 13.545087, 6367.47,  451,  337 }, 
   { "G145", 36.0, 46.0, 32.174,   90.159, 0.0, 0.0,  79.5, 12.0,      6367.47,  169,  145 }, 
   { "G146", 36.0, 46.0, 32.353,   89.994, 0.0, 0.0,  79.5, 12.0,      6367.47,  166,  142 }, 
   { "G163", 38.0, 38.0, 20.6,    118.3,   0.0, 0.0,  95.0,  5.0,      6367.47, 1008,  722 }, 
   { "G206", 25.0, 25.0, 22.289,  117.991, 0.0, 0.0,  95.0, 81.271,    6367.47,   51,   41 }, 
   { "G209", 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 44.0,      6367.47,  275,  223 }, 
   { "G211", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 81.271,    6367.47,   93,   65 }, 
   { "G212", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 40.635,    6367.47,  185,  129 }, 
   { "G215", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 20.318,    6367.47,  369,  257 }, 
   { "G218", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 12.191,    6367.47,  614,  428 }, 
   { "G221", 50.0, 50.0, 1.0,     145.5,   0.0, 0.0, 107.0, 32.463,    6367.47,  349,  277 }, 
   { "G222", 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 88.0,      6367.47,  138,  112 }, 
   { "G226", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 10.159,    6367.47,  737,  513 }, 
   { "G227", 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 5.079,     6367.47, 1473, 1025 }, 
   { "G236", 25.0, 25.0, 16.281, -233.862, 0.0, 0.0,  95.0, 40.635,    6367.47,  151,  113 }, 
   { "G237", 50.0, 50.0, 16.201, -285.72,  0.0, 0.0, 107.0, 32.463,    6367.47,   54,   47 }, 
   { "G241", 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 22.0,      6367.47,  549,  445 }, 
   { "G245", 35.0, 35.0, 22.98,    92.84,  0.0, 0.0,  80.0,  8.0,      6367.47,  336,  372 }, 
   { "G246", 40.0, 40.0, 25.97,   127.973, 0.0, 0.0, 115.0,  8.0,      6367.47,  332,  371 }, 
   { "G247", 35.0, 35.0, 22.98,   110.84,  0.0, 0.0,  98.0,  8.0,      6367.47,  336,  372 }, 
   { "G252", 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 20.317,    6367.47,  301,  225 }, 
