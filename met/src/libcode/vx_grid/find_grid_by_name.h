...
static const LambertData dtc_lambert_grids [] = {
   ...
   { "DTC164", 'N', 30, 48, 20.47,  122.042, 0.0, 0.0, 98.8, 13.3, ncep_earth_radius_km, 376, 280 },
   { "DTC165", 'N', 30, 48, 20.653, 121.907, 0.0, 0.0, 98.8, 13.3, ncep_earth_radius_km, 168, 280 },
   { "DTC166", 'N', 30, 48, 23.114, 100.997, 0.0, 0.0, 98.8, 13.3, ncep_earth_radius_km, 208, 280 },
...
static const LambertData ncep_lambert_grids [] = {
   ...
   { "G130", 'N', 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 13.545087, ncep_earth_radius_km,  451,  337 },
   { "G145", 'N', 36.0, 46.0, 32.174,   90.159, 0.0, 0.0,  79.5, 12.0,      ncep_earth_radius_km,  169,  145 },
   { "G146", 'N', 36.0, 46.0, 32.353,   89.994, 0.0, 0.0,  79.5, 12.0,      ncep_earth_radius_km,  166,  142 },
   { "G163", 'N', 38.0, 38.0, 20.6,    118.3,   0.0, 0.0,  95.0,  5.0,      ncep_earth_radius_km, 1008,  722 },
   { "G206", 'N', 25.0, 25.0, 22.289,  117.991, 0.0, 0.0,  95.0, 81.271,    ncep_earth_radius_km,   51,   41 },
   { "G209", 'N', 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 44.0,      ncep_earth_radius_km,  275,  223 },
   { "G211", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 81.271,    ncep_earth_radius_km,   93,   65 },
   { "G212", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 40.635,    ncep_earth_radius_km,  185,  129 },
   { "G215", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 20.318,    ncep_earth_radius_km,  369,  257 },
   { "G218", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 12.191,    ncep_earth_radius_km,  614,  428 },
   { "G221", 'N', 50.0, 50.0, 1.0,     145.5,   0.0, 0.0, 107.0, 32.463,    ncep_earth_radius_km,  349,  277 },
   { "G222", 'N', 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 88.0,      ncep_earth_radius_km,  138,  112 },
   { "G226", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 10.159,    ncep_earth_radius_km,  737,  513 },
   { "G227", 'N', 25.0, 25.0, 12.19,   133.459, 0.0, 0.0,  95.0, 5.079,     ncep_earth_radius_km, 1473, 1025 },
   { "G236", 'N', 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 40.635,    ncep_earth_radius_km,  151,  113 },
   { "G237", 'N', 50.0, 50.0, 16.201,   74.28,  0.0, 0.0, 107.0, 32.463,    ncep_earth_radius_km,   54,   47 },
   { "G241", 'N', 45.0, 45.0, -4.85,   151.1,   0.0, 0.0, 111.0, 22.0,      ncep_earth_radius_km,  549,  445 },
   { "G245", 'N', 35.0, 35.0, 22.98,    92.84,  0.0, 0.0,  80.0,  8.0,      ncep_earth_radius_km,  336,  372 },
   { "G246", 'N', 40.0, 40.0, 25.97,   127.973, 0.0, 0.0, 115.0,  8.0,      ncep_earth_radius_km,  332,  371 },
   { "G247", 'N', 35.0, 35.0, 22.98,   110.84,  0.0, 0.0,  98.0,  8.0,      ncep_earth_radius_km,  336,  372 },
   { "G252", 'N', 25.0, 25.0, 16.281,  126.138, 0.0, 0.0,  95.0, 20.317,    ncep_earth_radius_km,  301,  225 },
