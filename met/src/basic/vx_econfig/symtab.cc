...
switch ( type )  {
   ...
   case ste_integer:
      ...
      out << prefix << "Type  = " << stetype_to_string(type) << "\n";
      out << prefix << "Value = " << i << "\n";
      break;
...
if ( verbose )  mlog << Debug(1) << "Not found\n\n";
...
// mlog << Debug(1) << "Executing command \"" << command << "\"\n\n";
