...
static const char conf_key_rapid_inten_time[]   = "rapid_inten.time";
static const char conf_key_rapid_inten_exact[]  = "rapid_inten.exact";
static const char conf_key_rapid_inten_thresh[] = "rapid_inten.thresh";
