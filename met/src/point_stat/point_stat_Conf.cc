...
////////////////////////////////////////////////////////////////////////
   ...
   //
   //  Code for class point_stat_Conf
   //
...
point_stat_Conf::point_stat_Conf()
...
point_stat_Conf::point_stat_Conf(const point_stat_Conf &)

{

cerr << "\n\n  point_stat_Conf::point_stat_Conf(const point_stat_Conf &) -> should never be called!\n\n";
...
point_stat_Conf & point_stat_Conf::operator=(const point_stat_Conf &)

{

cerr << "\n\n  point_stat_Conf::operator=(const point_stat_Conf &) -> should never be called!\n\n";
...
void point_stat_Conf::init_from_scratch()
...
void point_stat_Conf::read(const char * _config_filename)
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"model\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"beg_ds\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"end_ds\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"fcst_field\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"obs_field\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"fcst_thresh\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"obs_thresh\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"fcst_wind_thresh\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"obs_wind_thresh\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"message_type\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"mask_grid\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"mask_poly\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"mask_sid\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"ci_alpha\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"boot_interval\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"boot_rep_prop\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"n_boot_rep\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"boot_rng\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"boot_seed\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"interp_method\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"interp_width\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"interp_thresh\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"output_flag\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"mult_obs_flag\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"rank_corr_flag\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"grib_ptv\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"tmp_dir\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"output_prefix\"\n\n";
...
if ( !_e && Panic )  {
   ...
   cerr << "\n\n  point_stat_Conf::read(const char *) -> can't get symbol table entry for variable \"version\"\n\n";
...
Result point_stat_Conf::fcst_field(int _i0)
...
int point_stat_Conf::n_fcst_field_elements()
...
Result point_stat_Conf::obs_field(int _i0)
...
int point_stat_Conf::n_obs_field_elements()
...
Result point_stat_Conf::fcst_thresh(int _i0)
...
int point_stat_Conf::n_fcst_thresh_elements()
...
Result point_stat_Conf::obs_thresh(int _i0)
...
int point_stat_Conf::n_obs_thresh_elements()
...
Result point_stat_Conf::fcst_wind_thresh(int _i0)
...
int point_stat_Conf::n_fcst_wind_thresh_elements()
...
Result point_stat_Conf::obs_wind_thresh(int _i0)
...
int point_stat_Conf::n_obs_wind_thresh_elements()
...
Result point_stat_Conf::message_type(int _i0)
...
int point_stat_Conf::n_message_type_elements()
...
Result point_stat_Conf::mask_grid(int _i0)
...
int point_stat_Conf::n_mask_grid_elements()
...
Result point_stat_Conf::mask_poly(int _i0)
...
int point_stat_Conf::n_mask_poly_elements()
...
Result point_stat_Conf::mask_sid()
...
Result point_stat_Conf::ci_alpha(int _i0)
...
int point_stat_Conf::n_ci_alpha_elements()
...
Result point_stat_Conf::boot_interval()
...
Result point_stat_Conf::boot_rep_prop()
...
Result point_stat_Conf::n_boot_rep()
...
Result point_stat_Conf::boot_rng()
...
Result point_stat_Conf::boot_seed()
...
Result point_stat_Conf::interp_method(int _i0)
...
int point_stat_Conf::n_interp_method_elements()
...
Result point_stat_Conf::interp_width(int _i0)
...
int point_stat_Conf::n_interp_width_elements()
...
Result point_stat_Conf::interp_thresh()
...
Result point_stat_Conf::output_flag(int _i0)
...
int point_stat_Conf::n_output_flag_elements()
...
Result point_stat_Conf::mult_obs_flag()
...
Result point_stat_Conf::rank_corr_flag()
...
Result point_stat_Conf::grib_ptv()
...
Result point_stat_Conf::tmp_dir()
...
Result point_stat_Conf::output_prefix()
...
Result point_stat_Conf::version()
