...
.. list-table:: Table 7.1 Header information for each file point-stat outputs.
  ...
  * - 24
    - LINE_TYPE
    - Output line types are listed in tables :ref:`table_PS_format_info_FHO` through :ref:`table_PS_format_info_MPR`.
