   ...
   //
      ...
      if(verbosity > 3) {
         cout << "Lambert Conformal Data:\n"
              << "p1_deg = " << lc_data.p1_deg << "\n"
              << "p2_deg = " << lc_data.p2_deg << "\n"
              << "p0_deg = " << lc_data.p0_deg << "\n"
              << "l0_deg = " << lc_data.l0_deg << "\n"
              << "lcen_deg = " << lc_data.lcen_deg << "\n"
              << "d_km = " << lc_data.d_km << "\n"
              << "r_km = " << lc_data.r_km << "\n"
              << "nx = " << lc_data.nx << "\n"
              << "ny = " << lc_data.ny << "\n" << flush;
     ...
     if(verbosity > 3) {
      ...
      if(verbosity > 3) {
         cout << "Stereographic Data:\n"
              << "p1_deg = " << st_data.p1_deg << "\n"
              << "p0_deg = " << st_data.p0_deg << "\n"
              << "l0_deg = " << st_data.l0_deg << "\n"
              << "lcen_deg = " << st_data.lcen_deg << "\n"
              << "d_km = " << st_data.d_km << "\n"
              << "r_km = " << st_data.r_km << "\n"
              << "nx = " << st_data.nx << "\n"
              << "ny = " << st_data.ny << "\n" << flush;
