...
////////////////////////////////////////////////////////////////////////
   ...
   //
   //
   //     File generated by program "do_ma_att_source"
   //
...
if ( area_min_set || area_max_set )  {
   ...
   if ( area_min_set && (i < area_min) )   return ( 0 );

   if ( area_max_set && (i > area_max) )   return ( 0 );
...
if ( area_filter_min_set || area_filter_max_set )  {
   ...
   if ( area_filter_min_set && (i < area_filter_min) )   return ( 0 );

   if ( area_filter_max_set && (i > area_filter_max) )   return ( 0 );
...
if ( area_thresh_min_set || area_thresh_max_set )  {
   ...
   if ( area_thresh_min_set && (i < area_thresh_min) )   return ( 0 );

   if ( area_thresh_max_set && (i > area_thresh_max) )   return ( 0 );
...
if ( intersection_area_min_set || intersection_area_max_set )  {
   ...
   if ( intersection_area_min_set && (i < intersection_area_min) )   return ( 0 );

   if ( intersection_area_max_set && (i > intersection_area_max) )   return ( 0 );
...
if ( union_area_min_set || union_area_max_set )  {
   ...
   if ( union_area_min_set && (i < union_area_min) )   return ( 0 );

   if ( union_area_max_set && (i > union_area_max) )   return ( 0 );
...
if ( symmetric_diff_min_set || symmetric_diff_max_set )  {
   ...
   if ( symmetric_diff_min_set && (i < symmetric_diff_min) )   return ( 0 );

   if ( symmetric_diff_max_set && (i > symmetric_diff_max) )   return ( 0 );
...
if ( centroid_x_min_set || centroid_x_max_set )  {
   ...
   if ( centroid_x_min_set && (x < centroid_x_min) )   return ( 0 );

   if ( centroid_x_max_set && (x > centroid_x_max) )   return ( 0 );
...
if ( centroid_y_min_set || centroid_y_max_set )  {
   ...
   if ( centroid_y_min_set && (x < centroid_y_min) )   return ( 0 );

   if ( centroid_y_max_set && (x > centroid_y_max) )   return ( 0 );
...
if ( centroid_lat_min_set || centroid_lat_max_set )  {
   ...
   if ( centroid_lat_min_set && (x < centroid_lat_min) )   return ( 0 );

   if ( centroid_lat_max_set && (x > centroid_lat_max) )   return ( 0 );
...
if ( centroid_lon_min_set || centroid_lon_max_set )  {
   ...
   if ( centroid_lon_min_set && (x < centroid_lon_min) )   return ( 0 );

   if ( centroid_lon_max_set && (x > centroid_lon_max) )   return ( 0 );
...
if ( axis_ang_min_set || axis_ang_max_set )  {
   ...
   if ( axis_ang_min_set && (x < axis_ang_min) )   return ( 0 );

   if ( axis_ang_max_set && (x > axis_ang_max) )   return ( 0 );
...
if ( length_min_set || length_max_set )  {
   ...
   if ( length_min_set && (x < length_min) )   return ( 0 );

   if ( length_max_set && (x > length_max) )   return ( 0 );
...
if ( width_min_set || width_max_set )  {
   ...
   if ( width_min_set && (x < width_min) )   return ( 0 );

   if ( width_max_set && (x > width_max) )   return ( 0 );
...
if ( aspect_ratio_min_set || aspect_ratio_max_set )  {
   ...
   if ( aspect_ratio_min_set && (x < aspect_ratio_min) )   return ( 0 );

   if ( aspect_ratio_max_set && (x > aspect_ratio_max) )   return ( 0 );
...
if ( curvature_min_set || curvature_max_set )  {
   ...
   if ( curvature_min_set && (x < curvature_min) )   return ( 0 );

   if ( curvature_max_set && (x > curvature_max) )   return ( 0 );
...
if ( curvature_x_min_set || curvature_x_max_set )  {
   ...
   if ( curvature_x_min_set && (x < curvature_x_min) )   return ( 0 );

   if ( curvature_x_max_set && (x > curvature_x_max) )   return ( 0 );
...
if ( curvature_y_min_set || curvature_y_max_set )  {
   ...
   if ( curvature_y_min_set && (x < curvature_y_min) )   return ( 0 );

   if ( curvature_y_max_set && (x > curvature_y_max) )   return ( 0 );
...
if ( complexity_min_set || complexity_max_set )  {
   ...
   if ( complexity_min_set && (x < complexity_min) )   return ( 0 );

   if ( complexity_max_set && (x > complexity_max) )   return ( 0 );
...
if ( intensity_10_min_set || intensity_10_max_set )  {
   ...
   if ( intensity_10_min_set && (x < intensity_10_min) )   return ( 0 );

   if ( intensity_10_max_set && (x > intensity_10_max) )   return ( 0 );
...
if ( intensity_25_min_set || intensity_25_max_set )  {
   ...
   if ( intensity_25_min_set && (x < intensity_25_min) )   return ( 0 );

   if ( intensity_25_max_set && (x > intensity_25_max) )   return ( 0 );
...
if ( intensity_50_min_set || intensity_50_max_set )  {
   ...
   if ( intensity_50_min_set && (x < intensity_50_min) )   return ( 0 );

   if ( intensity_50_max_set && (x > intensity_50_max) )   return ( 0 );
...
if ( intensity_75_min_set || intensity_75_max_set )  {
   ...
   if ( intensity_75_min_set && (x < intensity_75_min) )   return ( 0 );

   if ( intensity_75_max_set && (x > intensity_75_max) )   return ( 0 );
...
if ( intensity_90_min_set || intensity_90_max_set )  {
   ...
   if ( intensity_90_min_set && (x < intensity_90_min) )   return ( 0 );

   if ( intensity_90_max_set && (x > intensity_90_max) )   return ( 0 );
...
if ( intensity_user_min_set || intensity_user_max_set )  {
   ...
   if ( intensity_user_min_set && (x < intensity_user_min) )   return ( 0 );

   if ( intensity_user_max_set && (x > intensity_user_max) )   return ( 0 );
...
if ( intensity_sum_min_set || intensity_sum_max_set )  {
   ...
   if ( intensity_sum_min_set && (x < intensity_sum_min) )   return ( 0 );

   if ( intensity_sum_max_set && (x > intensity_sum_max) )   return ( 0 );
...
if ( centroid_dist_min_set || centroid_dist_max_set )  {
   ...
   if ( centroid_dist_min_set && (x < centroid_dist_min) )   return ( 0 );

   if ( centroid_dist_max_set && (x > centroid_dist_max) )   return ( 0 );
...
if ( boundary_dist_min_set || boundary_dist_max_set )  {
   ...
   if ( boundary_dist_min_set && (x < boundary_dist_min) )   return ( 0 );

   if ( boundary_dist_max_set && (x > boundary_dist_max) )   return ( 0 );
...
if ( convex_hull_dist_min_set || convex_hull_dist_max_set )  {
   ...
   if ( convex_hull_dist_min_set && (x < convex_hull_dist_min) )   return ( 0 );

   if ( convex_hull_dist_max_set && (x > convex_hull_dist_max) )   return ( 0 );
...
if ( angle_diff_min_set || angle_diff_max_set )  {
   ...
   if ( angle_diff_min_set && (x < angle_diff_min) )   return ( 0 );

   if ( angle_diff_max_set && (x > angle_diff_max) )   return ( 0 );
...
if ( area_ratio_min_set || area_ratio_max_set )  {
   ...
   if ( area_ratio_min_set && (x < area_ratio_min) )   return ( 0 );

   if ( area_ratio_max_set && (x > area_ratio_max) )   return ( 0 );
...
if ( intersection_over_area_min_set || intersection_over_area_max_set )  {
   ...
   if ( intersection_over_area_min_set && (x < intersection_over_area_min) )   return ( 0 );

   if ( intersection_over_area_max_set && (x > intersection_over_area_max) )   return ( 0 );
...
if ( complexity_ratio_min_set || complexity_ratio_max_set )  {
   ...
   if ( complexity_ratio_min_set && (x < complexity_ratio_min) )   return ( 0 );

   if ( complexity_ratio_max_set && (x > complexity_ratio_max) )   return ( 0 );
...
if ( percentile_intensity_ratio_min_set || percentile_intensity_ratio_max_set )  {
   ...
   if ( percentile_intensity_ratio_min_set && (x < percentile_intensity_ratio_min) )   return ( 0 );

   if ( percentile_intensity_ratio_max_set && (x > percentile_intensity_ratio_max) )   return ( 0 );
...
if ( interest_min_set || interest_max_set )  {
   ...
   if ( interest_min_set && (x < interest_min) )   return ( 0 );

   if ( interest_max_set && (x > interest_max) )   return ( 0 );
